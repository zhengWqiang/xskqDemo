...
<div class="loginbody">
    ...
    <form action="<%=path %>/login/doLogin1" method="post">
    <%--<form method="post">--%>
        <div class="loginbox">
            <ul>
                <li>
                ...
                <li>
                    <input name="type" id="admin" type="radio" value="1"/>管理员&nbsp; &nbsp;
                    <input name="type" id="teacher" type="radio" value="2"/>老师&nbsp; &nbsp;
                    <input name="type" id="student" type="radio" value="3" checked="checked"/>学生
                    <label id="warn">${warn}</label>
