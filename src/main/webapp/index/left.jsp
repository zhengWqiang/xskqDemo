...
<dl class="leftmenu">
    <c:if test="${type=='学生'}">
        <dd>
            ...
            <ul class="menuson">
                ...
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/qing/list"
                                    target="rightFrame">我的请假</a><i></i>
                </li>
            </ul>
        </dd>
        <dd>
            ...
            <ul class="menuson">
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/kao/mlist"
                                    target="rightFrame">我的考勤</a><i></i>
                </li>
            </ul>
        </dd>
        <dd>
            ...
            <ul class="menuson">
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/student/list"
                                    target="rightFrame">学生信息管理</a><i></i>
                </li>
            </ul>
        </dd>
        <dd>
    ...
    <c:if test="${type=='老师'}">
        ...
        <dd>
            ...
            <ul class="menuson">
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/kao/list"
                                    target="rightFrame">考勤管理</a><i></i>
                </li>
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/student/klist"
        ...
        <dd>
            ...
            <ul class="menuson">
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/teacher/list"
                                    target="rightFrame">老师信息管理</a><i></i>
                </li>
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/student/list"
                                    target="rightFrame">学生信息管理</a><i></i>
                ...
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/course/list"
                                    target="rightFrame">课程信息管理</a><i></i>
                </li>
            </ul>
        </dd>
        <dd>
    ...
    <c:if test="${type=='管理员'}">
        ...
        <dd>
            ...
            <ul class="menuson">
                ...
                <li>
                    <cite></cite><a href="${pageContext.request.contextPath }/admin/list"
