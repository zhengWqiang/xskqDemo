...
function getCourse(){
  			$.ajax({
  				...
  				success:function(json){
  					...
  					$("#courseid").val("${requestScope.tea.course.courseid}");
  				}
  			});
  		}
function save() {
	...
	document.forms[0].action = "${pageContext.request.contextPath }/teacher/doedit";
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0" onload="getCourse()">
		...
		<form id="form1" name="form1" method="post" action="">
			<input id="id" name="tea.id" type="hidden" value="${requestScope.tea.id }"/>
			<table cellpadding="3" cellspacing="1" border="1" class="tableBorder1" align="center">
				...
				<tr>
					...
					<td class="forumRowHighLight"><input id="number" name="tea.number" type="text" size="70%" value="${requestScope.tea.number }"/></td>
				</tr>
				<tr>
					<td class="forumRowHighLight" height="23" width="20%" align="center">姓名</td>
					<td class="forumRowHighLight"><input id="name" name="tea.name" type="text" size="70%" value="${requestScope.tea.name }"/></td>
				</tr>
				<tr>
					<td class="forumRowHighLight" height="23" width="20%" align="center">密码</td>
					<td class="forumRowHighLight"><input id="password" name="tea.password" type="text" size="70%" value="${requestScope.tea.password }"/></td>
				</tr>
				<tr>
					<td class="forumRowHighLight" height="23" width="20%" align="center">性别</td>
					<td class="forumRowHighLight">
						<c:if test="${requestScope.tea.sex=='男' }">
						...
						<c:if test="${requestScope.tea.sex=='女' }">
							<input id="sex" type="radio" name="tea.sex" value="男" style=" width:15px; height: 15px;" />男&nbsp; &nbsp;
	       					<input id="sex" type="radio" name="tea.sex" value="女" checked="checked" style=" width:15px; height: 15px;"/>女<br/>
	       				</c:if>
					</td>
				</tr>
				<tr>
					<td class="forumRowHighLight" height="23" width="20%" align="center">年龄</td>
					<td class="forumRowHighLight"><input id="age" name="tea.age" type="text" size="70%" value="${requestScope.tea.age }"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="forumRowHighLight"><input id="rdate" name="tea.rdate" type="text" size="70%"
													onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" value="${requestScope.tea.rdate }"/></td>
				</tr>
				<tr>
