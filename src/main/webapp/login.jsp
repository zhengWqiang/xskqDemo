		...
		<div class="loginbody">
			...
			<div class="loginbox">
				...
				<ul>
					...
					<!-- <li>
						<div id="war" class="div_w">
							<label class="warn" id="warn"></label>	
						</div>
					</li> -->
					<li>
						<input name="admin" id="admin" type="radio" value="管理员"/>管理员&nbsp; &nbsp;
						<input name="teacher" id="teacher" type="radio" value="老师"/>老师&nbsp; &nbsp;
						<input name="student" id="student" type="radio" value="学生" checked="checked"/>学生
						<label id="warn"></label>
